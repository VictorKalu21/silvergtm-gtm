...
Then read \`${RUN}/owner/sweep2/batches/batch-${i}-in.json\`: an array of leads with business_name, city, state, zip, website, brand_family, a ready-made query, and a registry domain. For EACH lead:
