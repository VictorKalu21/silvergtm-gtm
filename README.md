...
| [05](processes/05-devops-ic-hiring-signal.md) | DevOps-IC hiring-signal sourcing → person-level, source-linked sheet | You need hands-on DevOps/Platform/Infra ICs at mid-size product companies that are currently hiring for those roles and name Terraform/CloudFormation/Bicep in the JD — each lead with a verifiable posting URL + JD-quoted fit note. ATS JSON direct, WebSearch discovery, no SERP key. |
