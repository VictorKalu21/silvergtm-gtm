...
| [05](processes/05-ai-team-hiring-signal-apollo-ui.md) | AI-team + AI-hiring signal → Apollo-UI saved searches → scored list | You want companies that already have an AI team on payroll (leadership / ICs) or are hiring AI roles, as a proxy for meaningful AI spend — built from a paid Apollo seat with no API access, plus an optional Blitz multi-provider tag. |
