...
| [06](processes/06-account-based-revamp.md) | Account-based revamp / expansion | The same offer sold to businesses that already have the thing and want it extended, segmented or replaced. The buying trigger is internal and leaves no external signal, so this is account-based selling off process 05's baseline — not trigger sourcing. |
