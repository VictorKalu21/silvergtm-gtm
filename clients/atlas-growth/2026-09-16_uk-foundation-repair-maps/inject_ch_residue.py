...
ch = {}
for fn, conf in ((os.path.join('owner', 'residue', 'companies_house.jsonl'), 'matched'),
                 (os.path.join('owner', 'residue', 'companies_house_lowconf.jsonl'), 'low_confidence'),
                 (os.path.join('owner', 'residue', 'companies_house_pass2.jsonl'), 'pass2')):
