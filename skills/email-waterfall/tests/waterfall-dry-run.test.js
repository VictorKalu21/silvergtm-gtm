...
w('quickenrich', [{ key: k('A', 'jane acme', 'acme.com'), status: 'found', emails: ['jane@acme.com'], phone: '+1' }, { key: k('B', 'bob bravo', 'bravo.com'), status: 'found', emails: ['bob@bravo.com'] }, { key: k('C', 'carl charlie', 'charlie.com'), status: 'miss', emails: [] }, { key: k('D', 'dan delta', 'delta.com'), status: 'found', emails: ['dan@delta.com'] }]);
...
check('report per rung', rep.sendable === 2 && rep.risky === 1 && rep.none === 1 && rep.rungs.quickenrich.found === 3 && rep.rungs.quickenrich.sendable === 1 && rep.rungs.aiark.sendable === 1 && rep.rungs.trykitt.no_credits === 1);
