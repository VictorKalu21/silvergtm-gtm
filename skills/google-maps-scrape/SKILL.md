...
Flow — **owner-finding runs in-session by default; Clay is an optional last mile, not the end of the pipeline** (operator decision 2026-09-12). Order the rungs cheapest-first and stop when the yield says so:
